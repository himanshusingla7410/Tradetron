            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center overflow-hidden">
                    <a href="{{ route('dashboard') }}">
                        <img src="{{ asset('images/TT.webp') }}" alt="TT" class="h-9 w-auto">
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex ">
                    <x-nav-link :href="route('show-details')" :active="request()->routeIs('show-details')">
                        {{ __('Chat Record') }}
                    </x-nav-link>
                </div>
                @foreach ( config('admin.email') as $email )
                    @if ( Auth::check() && Auth::user()->email == $email )
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex ">
                            <x-nav-link :href="route('marketing')" :active="request()->routeIs('marketing')">
                                {{ __('Marketing') }}
                            </x-nav-link>
                        </div>
